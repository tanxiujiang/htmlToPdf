/*
 * $Id: UseTag.java 341 2012-06-18 14:38:54Z blowagie $
 *
			...
			Map<String, String> attributes = tag.getAttributes();
			 ...
			 if(id != null){
				 ...
				 if(list != null){
					 ...
					 l.add(new Group(list, getAttribute("x", attributes), getAttribute("y", attributes), getAttribute("width", attributes), getAttribute("height", attributes), tag.getCSS(), true));
					 return l;
				 }
			 }	 
