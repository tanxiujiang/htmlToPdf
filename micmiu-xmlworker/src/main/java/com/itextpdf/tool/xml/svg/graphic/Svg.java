/*
 * $Id: Svg.java 341 2012-06-18 14:38:54Z blowagie $
 *
...
public class Svg extends Graphic {
	...
	public Svg(float height, float width, com.itextpdf.text.Rectangle viewBox, Map<String, String> css){
		super(css);
		this.height = height;
		this.width = width;
	...
	public void draw(PdfContentByte cb) {
		...
		cb.concatCTM(1, 0, 0, -1, -viewBox.getLeft(), height - viewBox.getBottom());
	}
