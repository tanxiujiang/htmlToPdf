/*
 * $Id: Text.java 341 2012-06-18 14:38:54Z blowagie $
 *
...
public class Text extends Graphic {
	...
	public Text(Chunk chunk, Map<String, String> css, List<Integer> dx, List<Integer> dy){
		super(css);
		this.chunk = chunk;
		this.x = 0;
		this.y = 0;
	...
	public Text(Chunk chunk, float x, float y, Map<String, String> css, List<Integer> dx, List<Integer> dy){		
		super(css);
		this.chunk = chunk;
		this.x = x;
		this.y = y;
